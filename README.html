...
./upload_model.sh
Note: Ensure the script has executable permissions (chmod +x upload_model.sh).
...
Finally, create an Elasticsearch index with a semantic_text field. This special field type is linked to your inference endpoint and will automatically generate and store embeddings for any text you index into it.
